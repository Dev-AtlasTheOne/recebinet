...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon|null $data_recebido
     * @property \Illuminate\Support\Carbon $data_envio
     * @property string $path
     * @property string $status
     * @property string $titulo
     * @property int $fk_usuario_recebido
     * @property int $fk_usuario_envio
     * @property int $id
     * @property-read \App\Models\Usuario $usuarioEnvio
     * @property-read \App\Models\Usuario $usuarioRecebido
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereFkUsuarioEnvio($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereFkUsuarioRecebido($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereTitulo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf wherePath($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereDataEnvio($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereDataRecebido($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pdf>|Pdf timeout(int $seconds)
     ...
     */
    class Pdf extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Pdf> $pdfsEnviados
     * @property-read int|null $pdfs_enviados_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Pdf> $pdfsRecebidos
     * @property-read int|null $pdfs_recebidos_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereNome($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereCpf($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereCep($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereCidade($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereAssinatura($value)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
